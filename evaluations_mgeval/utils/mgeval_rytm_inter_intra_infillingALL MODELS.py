...
if __name__ == '__main__':
    ...
    # set_tags_analyzed = ['GMD', 'InfillingRandomLow', 'InfillingRandom']
    # eval_labels.append(['Ground Truth', new_names['InfillingClosedHH_Symbolic'], new_names['InfillingClosedHH']])
    # eval_labels.append(['Ground Truth', new_names['InfillingClosedHH'], new_names['InfillingKicksAndSnares']])
    ...
    hvo_seqs_list_removed_chh = get_version_with_removed_voices (gt_hvo_seqs_downsampled, voice_list =  [2], set_tag = "Ground Truth")
    hvo_seqs_list_removed_ks = get_version_with_removed_voices(gt_hvo_seqs_downsampled, voice_list =  [0, 1], set_tag="Ground Truth")
    ...
    corresponding_hvo_inputs = {
        ...
        "InfillingKicksAndSnares": np.array([hvo_sample.hvo for hvo_sample in hvo_seqs_list_removed_ks]),
    ...
    msos_ks_input = convert_hvo_seqs_to_msos(hvo_seqs_list_removed_ks, sf_path=soundfont)
    ...
    model_inputs = {
        ...
        "InfillingKicksAndSnares": msos_ks_input,
